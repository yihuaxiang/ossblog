...
1. `ubuntu 20` 服务器版：[ubuntu-20-live-server-amd64.iso](http://resources-zwiki.oss-cn-beijing.aliyuncs.com/system-mirror-iso/linux/ubuntu-20.04.4-live-server-amd64.iso)
2. `ubuntu 16` 桌面版：[ubuntu-16-desktop-amd64.iso](http://resources-zwiki.oss-cn-beijing.aliyuncs.com/system-mirror-iso/linux/ubuntu-16.04.7-desktop-amd64.iso)
2. `ubuntu 22` 桌面版：[ubuntu-16-desktop-amd64.iso](http://resources-zwiki.oss-cn-beijing.aliyuncs.com/system-mirror-iso/linux/ubuntu-22.04-desktop-amd64.iso)
3. `centos 8.2` 精简版：[CentOS-8.2.x86_64-minimal.iso](http://resources-zwiki.oss-cn-beijing.aliyuncs.com/system-mirror-iso/linux/CentOS-8.2.2004-x86_64-minimal.iso)
